        ...
        <> 
            ...
            <div className="bigbody">
                ...
                <section id="time-system">
                  ...
                  <p>
                    Time in <strong>TacTical Shooter</strong> moves exactly as it does in real life — one minute of gameplay equals one minute in-game. 
                    The world changes naturally around you, following a continuous day and night cycle that never speeds up or slows down. 
                    If you play for two hours, two hours pass in the game world.
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    it’s a tactical decision that shapes your story.
                  </p>
                </section>

                <section id="mission-timers">
  <h3>Mission Timers & Scheduling</h3>
  <p>
    Every mission in <strong>TacTical Shooter</strong> takes place within a living operational timeline. 
...
<section id="rest-recovery">
  <h3>Rest &amp; Recovery</h3>
  <p>
    In <strong>TacTical Shooter</strong>, survival isn’t just about firepower — it’s about endurance.  
...
<section id="fatigue-mental">
  <h3>Fatigue &amp; Mental State</h3>
  <p>
    Every soldier in <strong>TacTical Shooter</strong> is more than just a weapon — they’re human.  
...
<section id="squad-leadership">
  ...
  <p>
    In <strong>TacTical Shooter</strong>, you’re not just another operator — you’re the squad leader.  
...
<section id="squad-progression">
  ...
  <p>
    Every operator under your command in <strong>TacTical Shooter</strong> has a history — and you’re part of how it unfolds.  
...
<section id="mission-structure">
  ...
  <p>
    Operations in <strong>TacTical Shooter</strong> are more than checklists — they’re living, reactive scenarios.  
...
<section id="world-factions">
  ...
  <p>
    The story of <strong>TacTical Shooter</strong> unfolds in the aftermath of a failed military coup in mainland China.  
...
<section id="combat-tactics">
  ...
  <p>
    Combat in <strong>TacTical Shooter</strong> is built around precision, planning, and pressure.  
...
<section id="weapons-equipment">
  ...
  <p>
    Every weapon in <strong>TacTical Shooter</strong> is a tool — not a toy.  
...
<section id="logistics-resources">
  ...
  <p>
    ...
    In <strong>TacTical Shooter</strong>, every mission, bullet, and bandage is part of a larger campaign economy.  
  ...
  <p>
    ...
    In <strong>TacTical Shooter</strong>, war isn’t about endless resources — it’s about how far you can go before they run out.
  </p>
</section>

<section id="failure-consequences">
  <h3>Failure &amp; Consequences</h3>
  <p>
    In <strong>TacTical Shooter</strong>, failure isn’t the end — it’s part of the story.  
  ...
  <p>
    <strong>TacTical Shooter</strong> doesn’t punish you for losing; it challenges you to continue.  
...
<section id="campaign-progression">
  ...
  <p>
    The campaign in <strong>TacTical Shooter</strong> isn’t divided into levels — it’s a continuous, evolving operation.  
...
<section id="endgame-legacy">
  ...
  <p>
    Every campaign in <strong>TacTical Shooter</strong> ends — but how it ends is entirely up to you.  
  ...
  <p>
    <strong>TacTical Shooter</strong> isn’t about winning. It’s about leaving something behind.  
...
<section id="coop-multiplayer">
  ...
  <p>
    <strong>TacTical Shooter</strong> is designed first and foremost as a single-player experience —  
  ...
  <p>
    Whether played solo or with friends, <strong>TacTical Shooter</strong> remains one continuous story —  
...
<section id="technical-visual">
  ...
  <p>
    <strong>TacTical Shooter</strong> is built on a foundation of grounded realism —  
  ...
  <p>
    ...
    <strong>TacTical Shooter</strong> isn’t just played — it’s lived.
  </p>
</section>
...
<section id="about-redfolder">
  ...
  <p>
    <strong>TacTical Shooter</strong> represents everything we love about the art of interactive storytelling —  
  ...
  <p>
    Whether <strong>TacTical Shooter</strong> is ever fully realized or remains a digital blueprint,  
