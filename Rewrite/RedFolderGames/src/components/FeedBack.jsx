...
export function Feedback({ addFeedback }) {
    ...
    return (
        <div className="divForm">
            <div className='pt-1 rounded-xl shadow-[5px_5px_25px_rgba(255,255,255,0.25)] bg-white/5 w-full border border-white/10 mt-5 pb-5'>
                <div className="flex items-center justify-between px-4 py-2 border-b border-zinc-800">
                    ...
                    <div className="flex gap-2">
                        ...
                        <div className='h-5 w-5 bg-yellow-500 rounded-full flex justify-center'>
                            <span className='relative left-[0.6px] bottom-2.25 text-yellow-900/75 font-bold text-2xl'>-</span>
                        </div>
