function TTSContent() {
  ...
  return (
    <>
      <div className="cube right mt-15">
      ...
      <div className="cube left">
        <section id="fatigue-mental">
          ...
          <p>
            Every soldier in <strong>{Name}</strong> is more than just a tool — they’re human.
          ...
          <p>
            ...
            Neglecting their mental state can lead to breakdowns.
            These systems make your squad management important part of the game.
          </p>
        </section>
      </div>
      <div className="cube right">
