...
export default function Footer({ onStartCreditsGuide }) {
  ...
  const pageFooterClass = isAE ? "ae-siteFooter" : isUntitled ? "ues-siteFooter" : isSpace ? "sxe-siteFooter" : "";
  const footerLine = isAE
    ...
    : isUntitled
      ...
      : isSpace
        ? "Ship present. Cargo staged. From the basement, the only way is up."
