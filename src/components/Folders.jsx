...
const Games = [
    ...
    {
        name: "Untitled Space Extraction",
        link: "/RedFolderGames/SpaceExtraction",
        info: "Untitled Space Extraction is a co-op PvEvP scavenger game set around an abandoned orbital station where your physical ship is your stash, medical room, extraction point, and something other crews can steal."
    },
    {
        name: "Example Game",
